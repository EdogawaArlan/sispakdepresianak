<?php
	...
	if(isset($_POST['simpan']))
	{
		...
		$obj->penyakit_update($a,$b,$namafl,$id);
	}		
?>
<script>
	...
	<div class="input-form" >
		...
		<table class='tbl2'>
			<tr>
				...
				<td width='250'><input type='text' name='t1' value='<?php echo $obj->penyakit_pilih('1',$id) ?>' class="w3-input w3-border w3-sand"/></td>
			</tr>
			<tr>
				<td>	<label class="w3-text-blue">Nama penyakit	</label></td>
				<td><input type='text' name='t2' value='<?php echo $obj->penyakit_pilih('2',$id) ?>' class="w3-input w3-border w3-sand"/></td>
			</tr>
			<tr>
