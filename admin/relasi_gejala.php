	...
	if(isset($_POST['simpan']))
	{
		...
		if (!empty($_POST['txt_gjl'])){
			...
			while($i<$x)
			{
				...
				$obj_rel->add_relasi_gejala($kd_gj,$txtgjl);
				$i++;
			} 
		}
...
<div id="content">
	<div class="input-form" >
		<div class="w3-container w3-orange" >
			<h1>Input Relasi Penyakit Dengan Gejala</h1>
		</div>
...
<!-- Tampil Data ================================================================================================-->	
		<table class='tbl2'>
			<tr>
				<td colspan='2'><label class="w3-text-blue"><h2>Pilih <span class='blu'>Gejala </span> Sesuai Dengan Penyakit!</h2></label></td>
			</tr>
			<?php echo $obj_gj->list_gejala($kd_gj) ?>
			<tr height='30'></tr>
			<tr>
				<td colspan='2'><center>
